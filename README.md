...
这里按芯片品牌存放 [MCU StudioX](https://github.com/XieJunHui9566/MCU-StudioX) 的 `.mcupack` 器件包。当前目录收录 16 个普冉 PY32 包、1 个 Raspberry Pi RP2350 包及 23 个 STM32 HAL 包，共 40 个，均采用 StudioX Pack **格式 1**。
